...
describe("action routes", () => {
    ...
    describe("GET /digipet/ignore", () => {
        test("if the user has a digipet, it responds with a message about ignoring the digipet", () => __awaiter(void 0, void 0, void 0, function* () {
            // setup: reset digipet
            model_1.setDigipet(model_1.INITIAL_DIGIPET);
...
describe("GET /digipet/rehome", () => {
    test("if the user has a digipet, it responds with a message about remoing the digipet", () => __awaiter(void 0, void 0, void 0, function* () {
        // setup: reset digipet
        model_1.setDigipet(model_1.INITIAL_DIGIPET);
